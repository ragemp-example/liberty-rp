...
const timerBarLib = require("talrasha/talrasha_module/talrasha_time_bar.js");
			   ...
			   if (vehic === undefined) {
			    ...
			    if (find == false)  {
				     ...
				     if (dist < 10.0) {
				        ...
				        blipz2 = mp.blips.new(473, new mp.Vector3(126.815, -3105.666, 5.595), { alpha: 255, color: 74, scale: 1, name: "Склад" });
