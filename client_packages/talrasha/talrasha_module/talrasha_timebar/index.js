const { hideHudComponents } = require("talrasha/talrasha_module/talrasha_timebar/util");
const { gfxAlignWidth, gfxAlignHeight, initialY, initialBusySpinnerY, timerBarMargin, timerBarThinMargin } = require("talrasha/talrasha_module/talrasha_timebar/coordsAndSizes");
const TimerBarBase = require("talrasha/talrasha_module/talrasha_timebar/classes/TimerBarBase");
