const { barOffset, progressBaseX, progressWidth, progressHeight } = require("talrasha/talrasha_module/talrasha_timebar/coordsAndSizes");
const { clamp } = require("talrasha/talrasha_module/talrasha_timebar/util");
