const { textJustification, generateRandomString, getColorFromValue, drawTextLabel } = require("talrasha/talrasha_module/talrasha_timebar/util");
const { initialX, bgBaseX, bgOffset, bgThinOffset, timerBarWidth, timerBarHeight, timerBarThinHeight, titleScale, titleWrap } = require("talrasha/talrasha_module/talrasha_timebar/coordsAndSizes");
