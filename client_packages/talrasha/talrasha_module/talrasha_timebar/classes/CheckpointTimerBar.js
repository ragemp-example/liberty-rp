const { checkpointBaseX, checkpointOffsetX, checkpointOffsetY, checkpointWidth, checkpointHeight } = require("talrasha/talrasha_module/talrasha_timebar/coordsAndSizes");
const { clamp, getColorFromValue } = require("talrasha/talrasha_module/talrasha_timebar/util");
const { drawSprite } = mp.game.graphics;
const TimerBarBase = require("talrasha/talrasha_module/talrasha_timebar/TimerBarBase");
