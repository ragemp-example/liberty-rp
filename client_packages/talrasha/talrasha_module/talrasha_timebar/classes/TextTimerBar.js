const { textJustification, getColorFromValue, drawTextLabel } = require("talrasha/talrasha_module/talrasha_timebar/util");
const { initialX, textOffset, textScale, textWrap } = require("talrasha/talrasha_module/talrasha_timebar/coordsAndSizes");
