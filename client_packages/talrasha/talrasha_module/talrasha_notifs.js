...
mp.events.add("nSuccess", (text) => {
    mp.events.call("TalRashashowNotify", "success", "Удачно", text);
});

mp.events.add("nWarning", (text) => {
    mp.events.call("TalRashashowNotify", "warning", "Предупреждение", text);
});

mp.events.add("nError", (text) => {
    mp.events.call("TalRashashowNotify", "error", "Неудача", text);
});

mp.events.add("nInfo", (text) => {
    mp.events.call("TalRashashowNotify", "info", "Подсказка", text);
});

mp.events.add("nOffer", (text) => {
    mp.events.call("TalRashashowNotifyOffers", "info", "Предложение", text);
});