$(document).ready(function () {
   ...
   $("#buttonAccept").focus(() => {
    ...
    $("#ThemeTwo").click(() => {
      ...
      bg.style.backgroundImage = "url(./talrasha_image/talrasha_telephone/bgPink.png)";
      document.getElementById("imgIconBook").src="./talrasha_image/talrasha_telephone/iconBookPink.png";
      document.getElementById("imgIconMessage").src="./talrasha_image/talrasha_telephone/iconMessagePink.png";
      document.getElementById("messages").src="./talrasha_image/talrasha_telephone/messagesPink.png";
      document.getElementById("contacts").src="./talrasha_image/talrasha_telephone/contactsPink.png";
      document.getElementById("tools").src="./talrasha_image/talrasha_telephone/toolsPink.png";
      document.getElementById("arrowOne").src="./talrasha_image/talrasha_telephone/arrowPink.svg";
      document.getElementById("arrowTwo").src="./talrasha_image/talrasha_telephone/arrowPink.svg";
    ...
    $("#ThemeOne").click(() => {
      ...
      var bg = document.getElementById("uPhoneS");
      bg.style.backgroundImage = "url(./talrasha_image/talrasha_telephone/bgBlue.png)";
      document.getElementById("imgIconBook").src="./talrasha_image/talrasha_telephone/iconBook.png";
      document.getElementById("imgIconMessage").src="./talrasha_image/talrasha_telephone/iconMessage.png";
      document.getElementById("messages").src="./talrasha_image/talrasha_telephone/messages.png";
      document.getElementById("contacts").src="./talrasha_image/talrasha_telephone/contacts.png";
      document.getElementById("tools").src="./talrasha_image/talrasha_telephone/tools.png";
      document.getElementById("arrowOne").src="./talrasha_image/talrasha_telephone/arrow.svg";
      document.getElementById("arrowTwo").src="./talrasha_image/talrasha_telephone/arrow.svg";
      var numerals = document.getElementsByClassName("buttonNumeral");
      for(let i = 0; i < numerals.length; i++){
