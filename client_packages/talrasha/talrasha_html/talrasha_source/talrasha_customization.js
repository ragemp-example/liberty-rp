...
$(document).ready(function() {
    ...
    customizationApp = new Vue({
        ...
        data: {
            ...
            motherPic: "talrasha_image/talrasha_customization/parent/male_18.png",
            fatherPic: "talrasha_image/talrasha_customization/parent/female_20.png"
        },
        methods: {
...
function selectorToLeft() {
    ...
    if (
        ...
        if (items[item][1] === "motherSelector") {
            $('.family-preview img:first-child').attr('src', 'talrasha_image/talrasha_customization/parent/' + mothers[items[item][3]][0] + '.png');
        } else if (items[item][1] === "fatherSelector") {
            $('.family-preview img:last-child').attr('src', 'talrasha_image/talrasha_customization/parent/' + fathers[items[item][3]][0] + '.png');
        }
    }
}
