        ...
        switch(event.which) {
            case 113:
                if(window.clientStorage.faction === 4) {
                    ...
                    if (window.medicTablet.active() || window.pdTablet.active() || window.sheriffTablet.active() || window.armyTablet.active() || window.inventoryAPI.active() || window.playerMenu.active() || window.modalAPI.active() || window.chatAPI.active() || window.tradeAPI.active() || window.documentsAPI.active()) return;
                    if(showTablet === false) {
                            ...
                            <div className="pageB">
                                ...
                                <div className="else">
                                    ...
                                    <div className="info">
                                        ...
                                        <div className="header">Розыск</div> Всего: {this.state.data.wanted}
                                    </div>
                                </div> : ''}
                                <div className="buttons_nav">
