...
function loadVehiclesFromDB() {
    DB.Handle.query("SELECT * FROM talrasha_vehicle WHERE owner < ?", [1000], (e, result) => {
		...
		console.log(`\x1b[32m[DONE]\x1b[0m "Vehicles" package has been loaded: \x1b[33m${i}\x1b[0m.`);
    });
}
