module.exports = {
    "clothes_variation": {
        ...
        handler: (player, args) => {
            ...
            DB.Handle.query(`UPDATE talrasha_store_${args[1]} SET variation=? WHERE id=?`, [args[2], args[0]]);
    ...
    "clothes_price": {
        ...
        handler: (player, args) => {
            ...
            com.price = args[2];
            DB.Handle.query(`UPDATE talrasha_store_${args[1]} SET price=? WHERE id=?`, [args[2], args[0]]);
    ...
    "clothes_size": {
        ...
        handler: (player, args) => {
            ...
            DB.Handle.query(`UPDATE talrasha_store_${args[1]} SET rows=?,cols=? WHERE id=?`, [com.rows, com.cols, args[0]]);
    ...
    "clothes_addtexture": {
        ...
        handler: (player, args) => {
            ...
            DB.Handle.query(`UPDATE talrasha_store_${args[1]} SET textures=? WHERE id=?`, [JSON.stringify(com.textures), args[0]]);
